package edu.pingpong.guildedrose;

import edu.pingpong.guildedrose.guildedRose.GuildedRose;
import edu.pingpong.guildedrose.updatable.*;
...
public class App {
    public static void main(String[] args) {
        ...
        GuildedRose shop = new GuildedRose();
